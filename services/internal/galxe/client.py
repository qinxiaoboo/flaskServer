...
from flaskServer.services.internal.tls import TLSClient
...
if __name__ == '__main__':
    account = AccountInfo(evm_address="0x670d0e57dc475ec92c9268bbec5db9e5162378e2",
                          evm_private_key="0xc51088f918507b59d312da4938d7558d1e87d08d2bc27716f76fc4138c31339f")
    client = Client(account)
    result = asyncio.run(client.galxe_id_exist())
    print(result)
