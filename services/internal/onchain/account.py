...
from flaskServer.services.internal.onchain.constants import SCANS, EIP1559_CHAINS, SPACE_STATION_ABI
...
class OnchainAccount:
    ...
    def __init__(self, account: AccountInfo, chain: str):
        ...
        self.chain = chain
        self.w3 = get_w3(account.user_agent, RPCs[chain], self.proxy)
