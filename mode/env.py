...
class Env(db.Model):
    ...
    tw_id = db.Column(db.Integer, unique=False, nullable=True)
    discord_id = db.Column(db.Integer, unique=False, nullable=True)
    outlook_id = db.Column(db.Integer, unique=False, nullable=True)
    okx_id = db.Column(db.Integer, unique=False, nullable=True)
    init_id = db.Column(db.Integer, unique=False, nullable=True)
    bitlight_id = db.Column(db.Integer, unique=False, nullable=True)
    ...
    user_agent = db.Column(db.String(255), unique=False, nullable=False)
